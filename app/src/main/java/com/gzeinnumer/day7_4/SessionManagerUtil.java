...
public class SessionManagerUtil {
    ...
    public static final String SESSION_PREFERENCE = "com.gzeinnumer.day7_4.SessionManagerUtil.SESSION_PREFERENCE";
    public static final String SESSION_TOKEN = "com.gzeinnumer.day7_4.SessionManagerUtil.SESSION_TOKEN";
    public static final String SESSION_EXPIRY_TIME = "com.gzeinnumer.day7_4.SessionManagerUtil.SESSION_EXPIRY_TIME";
    public static final String SESSION_ID = "com.gzeinnumer.day7_4.SessionManagerUtil.ID";
    ...
    public void storeID(Context context, String token){
        SharedPreferences.Editor editor =
                context.getSharedPreferences(SESSION_PREFERENCE, Context.MODE_PRIVATE).edit();
